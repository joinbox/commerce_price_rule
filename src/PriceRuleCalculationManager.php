 ...
 *
 * @see \Drupal\commerce_price_rule\Annotation\CommercePriceRuleCalculation
 * @see plugin_api
 */
class PriceRuleCalculationManager extends DefaultPluginManager {
  ...
  public function __construct(
    ...
    parent::__construct(
      'Plugin/Commerce/PriceRuleCalculation',
      $namespaces,
      $module_handler,
      'Drupal\commerce_price_rule\Plugin\Commerce\PriceRuleCalculation\PriceRuleCalculationInterface',
      'Drupal\commerce_price_rule\Annotation\CommercePriceRuleCalculation'
    );
